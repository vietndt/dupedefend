...
const subscriptionId = 336; // REPLACE this with your subscription ID
...
const makeRequest = async (videoOrChannelId: string, ownerWalletAddress: string, type: string): Promise<any> => {
  return new Promise(async (resolve, rej) => {
    ...
    const secrets: any = { apiKey: process.env.YOUTUBE_API_KEY, rpcUrl: process.env.POLYGON_MUMBAI_RPC_URL };
